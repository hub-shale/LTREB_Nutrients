---
title: "Metadata - Nutrients - Upper Clark Fork River - WY2019"
---
...
#  ./04_product/AnnualAggregateFile-NH4-SRP-NO3-WY2019.csv
...
dataset.title <- paste(
  ...
  "during water year 2019 (1 Oct 2018 - 30 Sept 2019)"
)
...
other["Shale",] <- people["ShaleH",];
other["Shale",]$role <- "Data curation"
...
# THIS IS BREAKING
# RAPCOMMENT: See the processing script. The strings used for indexing need to
# match those in the master list exactly for this to work. I.e., "1" is not
# going to match "001".
...
otherNames <- c(
  ...
  "02_protocol.zip",
  "03_incremental.zip",
  "AnnualAggregateFile-NH4-SRP-NO3-WY2019_vis.pdf"
);
otherDescs <- c(
  paste(
...
package.id <- "edi.906.3" # UPDATED FOR 2019
